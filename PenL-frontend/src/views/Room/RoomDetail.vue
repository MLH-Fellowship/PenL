<template>
<div>
  <div class="row  h-100 px-5  justify-content-center align-items-center mt-5">
    ...
    <div class="col-12  col-md-4 mt-5 mt-md-0">
        ...
        <div class="card shadow my-5 px-2 light-green-bg">
            ...
            <div class="card-body text-center">
                <h1 class="sub-heading mt-3 card-title playful">
                   <span class="color-purple ">{{ room_details.room_name}} Invite Link</span>
                </h1>
        ...
        <div class="card shadow my-5 px-2 light-green-bg">
            ...
            <div class="card-body text-center">
                <h1 class="sub-heading mt-3 card-title">
                   <span class="color-purple playful mr-2">Players in Room:</span><span class="color-green">{{ room_details.players_count}}</span>
                </h1>
